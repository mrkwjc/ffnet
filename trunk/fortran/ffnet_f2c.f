...
c.....variables
      ...
      double precision xprime(n), diff(100000), bunits(100000)
c.....helper variables
...
c.....variables
      ...
      double precision x(n), units(u), dunits(100000)
      double precision input(i), deriv(o,i)
c.....helper variables
...
c.....variables
      ...
      double precision x(n), x2(100000), units(u)
      double precision Input(p,i), Targ(p,o)
...
c.....variables
      ...
      double precision eni(i,2), deo(o,2)
c.....helper variables
      double precision tmpinp(100000), tmpout(100000)
      integer j, k
c.....f2py statements
cf2py intent(out) output, istat
...
c.....helper variables
      integer j, k, l
      double precision tmpinp(100000), tmpder(1000, 1000)
c.....f2py statements
cf2py intent(out) deriv
...
c.....variables
      ...
      integer conec(n,2), bconecno(bn), inno(i), outno(o)
      double precision x(n), units(u), Input(p,i), Targ(p,o)
      double precision xprime(100000), update, update0(100000)
      double precision eta, moment
c.....helper variables
      integer j, k
c.....f2py statements
...
c.....variables
      ...
      integer conec(n,2), bconecno(bn), inno(i), outno(o)
      double precision x(n), units(u), Input(p,i), Targ(p,o)
      double precision xprime(100000), xprime0(100000), xmi(n)
